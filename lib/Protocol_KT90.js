...
KT90.prototype.getCommandByCode = function(code) {
...
KT90.prototype.getEventByCode = function(code) {
 ...
 */
KT90.prototype.parseMessage = function( buffer ) {
 ...
 */
 KT90.prototype.parsePosition = funtion( data ) {
  
  return new Position();
}

KT90.prototype.prepare = function(imei, cmd, data) {
