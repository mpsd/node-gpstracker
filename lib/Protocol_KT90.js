...
Protocol.prototype.parsePosition = function( data ) {
  ...
  UTCDate.setUTCFullYear( parseInt('20' + parts[6].substr(0, 2), 10) );
  UTCDate.setUTCMonth(    parseInt(parts[6].substr(2,2), 10) - 1     );
  UTCDate.setUTCDate(     parseInt(parts[6].substr(4,2), 10)         );
  UTCDate.setUTCHours(    parseInt(parts[6].substr(6,2), 10)         );
  UTCDate.setUTCMinutes(  parseInt(parts[6].substr(8,2), 10)         );
  UTCDate.setUTCSeconds(  parseInt(parts[6].substr(10,2), 10)        );
